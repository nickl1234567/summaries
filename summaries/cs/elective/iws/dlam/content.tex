	...
	\section{Probabilistic Circuits} % 10b.104, 10b.126
		...
		\begin{center}
			\begin{tikzpicture}[->, comp/.style = { draw, circle, minimum width = 0.75cm, minimum height = 0.75cm, inner sep = 0 }]
				...
				\node [comp, right = 1 of a] (b) {\includegraphics[width=0.5cm]{img/gaussian.pdf}};
		...
		\begin{center}
			\begin{tikzpicture}[->, comp/.style = { draw, circle, minimum width = 0.75cm, minimum height = 0.75cm, inner sep = 0 }]
				\node [comp] (a) {\includegraphics[width=0.5cm]{img/gaussian.pdf}};
				\node [comp, below = 0.5 of a] (b) {\includegraphics[width=0.5cm]{img/gaussian.pdf}};
				\node [comp, below = 0.5 of b] (c) {\includegraphics[width=0.5cm]{img/gaussian.pdf}};
